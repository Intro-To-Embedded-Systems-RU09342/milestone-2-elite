...
void temperature_control(void)
{
    ...
    while(change_temp_lower == 1)           //if user wants to change the temperature lower
    {
        ...
        {
            TA0CCR1 = 255;      //100% duty cycle
        }
        else if (desired_temp > 27 && desired_temp < 30)        //check desired temperature
        {
            TA0CCR1 = 230;      //90% duty cycle
        }
        else if (desired_temp == 30)        //check desired temperature
            {
                TA0CCR1 = 204;      //80% duty cycle
            }
        else if (desired_temp ==31)     //check desired temperature
            {

                TA0CCR1 = 178;      //70% duty cycle
            }
        else if (desired_temp > 31 && desired_temp < 34)        //check desired temperature
            {

                TA0CCR1 = 127;      //50% duty cycle
            }
        else if (desired_temp >= 34 && desired_temp < 36)       //check desired temperature
            {
        ...
        else if (desired_temp >= 38 && desired_temp < 41)       //check desired temperature
            {

                TA0CCR1 = 63;      //25% duty cycle
            }
        else if (desired_temp >= 41 && desired_temp < 45)       //check desired temperature
            {

                TA0CCR1 = 51;      //20% duty cycle
            }
        else if (desired_temp >= 45 && desired_temp < 49)       //check desired temperature
            {

                TA0CCR1 = 38;      //15% duty cycle
            }
        else if (desired_temp >= 49)        //check desired temperature
            {
